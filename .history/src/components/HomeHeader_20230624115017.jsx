  ...
  return (
    <header className="container mx-auto p-5 flex items-center justify-end">
        <div className="flex items-center gap-6 text-sm">
            ...
            <LuLayoutGrid className="text-4xl bg-transparent hover:bg-gray-100 rounded-lg p-1"/>
            <button className="py-2 px-6 bg-pink-300 rounded-md hover:drop-shadow-md transition-transform duration-200">Sign in</button>
