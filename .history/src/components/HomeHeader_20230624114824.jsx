...
export default function HomeHeader() {
  return (
    <header className="container mx-auto p-5 bg-red-200 flex items-center justify-end">
        <div className="flex items-center gap-6 text-sm">
            ...
            <button className="py-2 px-6 bg-pink-500 rounded-md hover:drop-shadow-md transition-transform duration-200">Sign in</button>
